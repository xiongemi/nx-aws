 ...
 */
export function getWorkspaceId(workspaceRootPath: string = workspaceRoot): string {
  ...
  if (dbFiles.length > 1) {
    ...
    dbFilesWithStats.sort((a, b) => b.mtime - a.mtime);
 ...
 */
export function getWorkspaceDataPath(workspaceRootPath: string = workspaceRoot): string {
